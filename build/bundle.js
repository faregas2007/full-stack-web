...
(() => {
  ...
  (() => {
    ...
    var m = function (e, n) {
        switch (n) {
          case "ADD_TODO":
            return { id: n.id, text: n.text, completed: !1 };
          case "TOGGLE_TODO":
            return d(d({}, e), {}, { completed: !n.completed });
          default:
            return e;
        }
      },
          ...
          (r = [
            {
              key: "render",
              value: function () {
                this.props.todos.map(function (n) {
                  return e.createElement("li", { key: n.id }, n.text);
                });
              },
            },
          ]),
    ...
    const y = function () {
      return e.createElement(g, { todos: (state = v.getState().todos) });
    };
    n.render(e.createElement(y, null), document.querySelector("#root"));
  })();
})();
